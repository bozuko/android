...
public final class GridLayer extends RootLayer implements MediaFeed.Listener{
...
//    	}
    ...
    public boolean tapGesture(int slotIndex, boolean metadata) {
        ...
        if (!feed.isClustered()) {
            ...
            setState(STATE_GRID_VIEW);
        	return false;
//        	Log.v("tapGesture", "clustering");
//            if (!feed.hasExpandedMediaSet()) {
//            	Log.v("tapGesture", "hasExpandedMediaSet");
...
//        }
    ...
    public GridInputProcessor getInputProcessor() {
