...
//            }
            if ((action == MotionEvent.ACTION_POINTER_1_DOWN || action == MotionEvent.ACTION_POINTER_2_DOWN)
                    && motion.getPointerCount() >= 2) {
                // We have a new multi-finger gesture
                mBottomFingerBeginX = motion.getX(0);
                mBottomFingerBeginY = motion.getY(0);
                mTopFingerBeginX = motion.getX(1);
                mTopFingerBeginY = motion.getY(1);
            ...
            case MotionEvent.ACTION_POINTER_2_UP:
                ...
                if (mPointerOneUp || mPointerTwoUp) {
                    ...
                    mFocusX = motion.getX(id);
                    mFocusY = motion.getY(id);
    ...
    private void setContext(MotionEvent curr) {
        ...
        MotionEvent prevm = prev;
        MotionEvent curm = curr;
        
        final float px0 = prevm.getX(0);
        final float py0 = prevm.getY(0);
        final float px1 = prevm.getX(1);
        final float py1 = prevm.getY(1);
        final float cx0 = curm.getX(0);
        final float cy0 = curm.getY(0);
        final float cx1 = curm.getX(1);
        final float cy1 = curm.getY(1);
        ...
        mCurrPressure = curm.getPressure(0) + curm.getPressure(1);
        mPrevPressure = prevm.getPressure(0) + prevm.getPressure(1);
