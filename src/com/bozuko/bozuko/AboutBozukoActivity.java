...
import com.fuzz.android.ui.PageIndicator;
...
public class AboutBozukoActivity extends BozukoControllerActivity implements
		OnClickListener {
	protected static final int PAGE_INDICATOR = 555;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		PageIndicator pi = new PageIndicator(this, about.size());
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
				LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
		params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
		pi.setId(PAGE_INDICATOR);
		rl.addView(pi, params);
	...
	class CustomPaging implements PagingAdapter {
		...
		public View getView(int position, View ConvertView) {
			...
			if (ConvertView == null) {
				...
				DisplayMetrics metrics = new DisplayMetrics();
				getWindowManager().getDefaultDisplay().getMetrics(metrics);
				LayoutParams params = new LayoutParams(metrics.widthPixels,
		...
		public void onPage(int page) {
			// TODO Auto-generated method stub
			PageIndicator pi = (PageIndicator) findViewById(PAGE_INDICATOR);
			if (pi != null) {
				pi.setPage(page);
			}
