...
public class TouchInterceptor extends ListView {
	...
	public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        mItemHeightNormal = res.getDimensionPixelSize(Res.dimen.normal_height);
        mItemHeightHalf = mItemHeightNormal / 2;
        mItemHeightExpanded = res.getDimensionPixelSize(Res.dimen.expanded_height);
    }
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    View dragger = item.findViewById(Res.id.icon);
                    Rect r = mTempRect;
	...
	private void startDragging(Bitmap bm, int y) {
        ...
        int backGroundColor = context.getResources().getColor(Res.color.dragndrop_background);
